...
for n in range(51):
    ...
    for x in range(num_iters):
        ...
        xx_orig = xx
        xx0 = xx[0] + noise*base_noise*np.random.randn(15,2)
        xx1 = xx[1] + noise*base_noise*np.random.randn(15,2)
        xx2 = xx[2] + noise*base_noise*np.random.randn(15,2)
        xx3 = xx[3] + noise*base_noise*np.random.randn(15,2)
        xx = [xx0,xx1,xx2,xx3]
        ...
        if len(err_P) > 0:
            #print(min(err_R))
            #print(str(min(err_P))+" "+str(180*min(err_R)/3.141592654))
            ex_pose += 1
