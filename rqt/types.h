...
struct TrackSettings {
  TrackSettings()
      : init_dt_(0.05), // m2 tStep, t_step, raw interface code initDt
        ...
        dt_decrease_factor_(
            1. / dt_increase_factor_), // m2 stepDecreaseFactor not existent in
        ...
        max_corr_steps_(
            3), // m2 maxCorrSteps (track.m2 param of rawSetParametersPT corresp
  ...
  double
      epsilon_; // m2 CorrectorTolerance (chicago.m2, track.m2), raw interface
  ...
  unsigned
      max_corr_steps_; // m2 maxCorrSteps (track.m2 param of rawSetParametersPT
