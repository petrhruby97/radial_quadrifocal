...
void get_symmetric_cams(Eigen::Matrix<double, 2, 4> *Ps,
                        Eigen::Matrix<double, 2, 4> *Ps_sym) {
...
int radial_quadrifocal_solver(const std::vector<Eigen::Vector2d> &p1s,
  ...
  Eigen::JacobiSVD<Eigen::Matrix<double, 13, 16>> svd(
      coef_matrix, Eigen::ComputeFullU | Eigen::ComputeFullV);
