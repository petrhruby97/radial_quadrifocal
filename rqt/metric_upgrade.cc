...
int metric_upgrade(const std::vector<Eigen::Vector2d> &x1, const std::vector<Eigen::Vector2d> &x2,
    ...
    Eigen::Matrix4d Q1;
    Q1(0, 0) = q1(0); Q1(0, 1) = q1(1); Q1(0, 2) = q1(2); Q1(0, 3) = q1(3);
    Q1(1, 0) = q1(1); Q1(1, 1) = q1(4); Q1(1, 2) = q1(5); Q1(1, 3) = q1(6);
    Q1(2, 0) = q1(2); Q1(2, 1) = q1(5); Q1(2, 2) = q1(7); Q1(2, 3) = q1(8);
    Q1(3, 0) = q1(3); Q1(3, 1) = q1(6); Q1(3, 2) = q1(8); Q1(3, 3) = q1(9);

    Eigen::Matrix4d Q2;
    Q2(0, 0) = q2(0); Q2(0, 1) = q2(1); Q2(0, 2) = q2(2); Q2(0, 3) = q2(3);
    Q2(1, 0) = q2(1); Q2(1, 1) = q2(4); Q2(1, 2) = q2(5); Q2(1, 3) = q2(6);
    Q2(2, 0) = q2(2); Q2(2, 1) = q2(5); Q2(2, 2) = q2(7); Q2(2, 3) = q2(8);
    Q2(3, 0) = q2(3); Q2(3, 1) = q2(6); Q2(3, 2) = q2(8); Q2(3, 3) = q2(9);
